  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          width: state === "collapsed" && collapsible === "icon"
            ? (variant === "floating" || variant === "inset"
              ...
              : "var(--sidebar-width-icon)")
            : "var(--sidebar-width)",
          left: state === "collapsed" && collapsible === "offcanvas" && side === "left"
            ? "calc(var(--sidebar-width) * -1)"
            : side === "left" ? "0" : undefined,
          right: state === "collapsed" && collapsible === "offcanvas" && side === "right"
            ? "calc(var(--sidebar-width) * -1)"
        ...
        className={cn(
          "fixed inset-y-0 z-10 h-screen transition-[left,right,width] duration-200 ease-linear border-r",
      ...
      >
        <div
          ...
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "bg-sidebar border-sidebar-border rounded-lg border shadow-sm"
              : "bg-sidebar"
          )}
        >
          {children}
